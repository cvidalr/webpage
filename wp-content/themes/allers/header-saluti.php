...
<!--scroll promotional-->
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/jquery.tinyscrollbar.min.js"></script>
	<script type="text/javascript">
		$(document).ready(function(){
...
$(document).ready(function(){
$('#tabsEvent div').hide();
$('#tabsEvent div:first').show();
$('#tabsEvent ul li:first').addClass('active');
$('#tabsEvent ul li a').click(function(){ 
$('#tabsEvent ul li').removeClass('active');
...
<body>
<div class="wrapper salut">
<div class="headerMain">
  <div class="header">
    <div class="headerLeft">
      <div class="logo"><a href="<?php echo qtrans_convertURL(esc_url( home_url( '/saluti/home/' ) )); ?>" title="allers"></a></div>
    </div>
...
?>
      ...
      <?php dynamic_sidebar( 'saluti-headerbutton' );?>
      <div class="search">
        <?php get_search_form(); ?>
      </div>
    </div>
