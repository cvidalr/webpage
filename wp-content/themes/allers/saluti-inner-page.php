<?php
/**
 * Template Name: Saluti Inner Page Template
...
<div class="container">
  ...
  <?php 
		  $imageContent ='';
		  $imageDetails = get_field('saluti_image', $my_query->post->ID); 
		  if($imageDetails){
		  ...
		  $subDetails = get_pages("sort_order=ASC&sort_column=menu_order&child_of=$post->ID&post_type=saluti");
		  ...
		  if(is_array($subDetails)){
			  ...
			  foreach( $subDetails as $sub){
				  ...
				  $imageBannerContent ='';
				  $imageBannerDetails = get_field('saluti_banner_image', $sub->ID); 
				  ...
				  $imageInnnerContent ='';
				  $imageInnnerDetails = get_field('saluti_image', $sub->ID); 
		  ...
		  $imageAbtBannerDetails = get_field('saluti_banner_image', $post->ID); 
