...
<div class="container">
  ...
  <?php 
		 ...
		 $subDetails = get_pages("sort_order=ASC&sort_column=menu_order&child_of=$post->ID");
		  ...
		  if(is_array($subDetails)){
			  ...
			  foreach( $subDetails as $sub){
				  ...
				  $imageBannerContent ='';
				  $imageBannerDetails = get_field('allers_about_us_banner_image', $sub->ID); 
				  ...
				  $imageInnnerContent ='';
				  $imageInnnerDetails = get_field('image', $sub->ID); 
		  ...
		  $imageAbtBannerDetails = get_field('allers_about_us_banner_image', $post->ID); 
  ...
  <div class="main">
    ...
    <ul class="salutBox salutBoxInner" style="display:none;">
      <li>
        <div class="cellL">
